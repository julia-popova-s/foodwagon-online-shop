...
- Реализовала логику сохранения информации о заказах пользователей в базе данных Firebase
- Реализовала функционал авторизации/регистрации в приложении (Firebase)
